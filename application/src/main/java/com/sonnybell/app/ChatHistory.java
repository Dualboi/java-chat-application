 ...
 * It stores a limited number of messages and provides methods to add and retrieve them.
 * This class is thread-safe and ensures that the message history is synchronized
 * across multiple threads.
 * Uses a LinkedList to store messages, allowing for efficient addition and removal
 * of messages.
 * The maximum number of messages stored is defined by the MAX_HISTORY constant.
 * When the maximum is reached, the oldest message is removed to make space for the new one.
